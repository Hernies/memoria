...
\usepackage{amsmath} % habilita introducir texto plano en ecuaciones



%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Configuración para insertar y referirse a código en cualquier
\usepackage{listings}%% lenguaje de programación
\usepackage{graphicx} %%insertar svgs, pdfs, imágenes...
\usepackage{float} %% fixes figures to their definition, to fix, use [H] after the \begin of a figure
